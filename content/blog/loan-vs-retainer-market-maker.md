---
title: "Loan vs. Retainer: How Market Maker Deals Are Structured"
description: "Crypto market makers are usually paid in one of two ways: a fixed monthly retainer, or a token loan plus call options. Here is how each model works, the trade-offs, and how to choose the right structure for your token."
date: 2025-11-18
updated: 2025-11-18
author: "GREED Labs"
...
draft: false
faq:
  - question: "What is the token loan and call option model?"
    answer: "You lend tokens to the market maker to use as trading inventory, and instead of a cash fee they are compensated through call options — the right to buy some of those tokens later at preset strike prices. It lets projects with limited cash still get liquidity, and ties the market maker's upside to the token's performance."
  - question: "Is a retainer or a loan cheaper?"
    answer: "It depends on your token's price path. A retainer is a fixed, predictable cash cost. A loan-plus-options deal costs little upfront but can become expensive if the token appreciates sharply, because the options grow more valuable. Neither is universally cheaper."
  - question: "Can I combine both models?"
    answer: "Yes. Hybrid deals — a smaller retainer plus a token loan — are common. They balance predictable cost with lower cash outlay and can align incentives without handing over large option exposure."
---
...
This guide explains each structure, the trade-offs, and how to pick one. For the underlying numbers, pair it with [How Much Does a Crypto Market Maker Cost?](/blog/crypto-market-maker-cost).
...
Instead of cash, you **lend tokens** to the market maker to use as trading inventory. They are compensated through **call options** — the right to buy some of those loaned tokens later at preset strike prices. See the [glossary](/blog/market-making-glossary) for the underlying terms.
...
Whichever structure you pick, judge the market maker on the same things: spread, depth, uptime, and transparent reporting. See [How to Choose a Crypto Market Maker](/blog/how-to-choose-a-market-maker).
