---
title: "What Is Bubblemaps? Token Holder Concentration Explained"
description: "Bubblemaps visualizes how a token's supply is distributed across wallets. High concentration signals risk to investors — here's how to read it and improve your token's health score."
date: 2021-06-12
updated: 2021-06-12
author: "GREED Labs"
...
draft: false
faq:
  - question: "Why does holder concentration matter?"
    answer: "When a small number of linked wallets hold a large share of supply, those wallets can sell into the market at any time and crash the price. Investors read that concentration as sell-pressure risk and a sign of possible manipulation, so it suppresses buying and hurts a token's reputation."
  - question: "What is a healthy holder distribution?"
    answer: "A healthy distribution spreads supply across many independent holders rather than a few connected clusters, with no single entity able to move the market on its own. There is no universal magic number, but the goal is broad, organic ownership where team, treasury, and investor allocations are transparent and clearly labeled rather than hidden behind unrelated-looking wallets."
  - question: "Can holder concentration be improved?"
    answer: "Yes, but the honest path is building genuine demand and distribution over time — real liquidity, real buyers, and transparent handling of team and treasury allocations. It cannot legitimately be faked by shuffling tokens between wallets to disguise ownership, which analytics tools like Bubblemaps are specifically designed to expose."
---
